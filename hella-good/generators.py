...
class CubeGen:
	...
	def __init__(self, arrayFile, tsvFile, trainImagesDF, valImagesDF, autoencoder=False, storeInRam=False):
		'''
...
def imageCubeGen(imageArray, imageDF, noduleDF, candidatesDF, cubeSize=20, autoencoder=False, atMost=200):
	while True:
